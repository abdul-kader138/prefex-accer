...
function reload_tasks_tables() {
    var e = [".table-tasks", ".table-rel-tasks", ".table-rel-tasks-leads", ".table-timesheets"];
    $.each(e, function (e, t) {
...
function init_task_modal(e) {
    var t = "",
        a = $("#lead-modal"),
        i = $("#_task_modal");
    a.is(":visible") ? (t += "?opened_from_lead_id=" + a.find('input[name="leadid"]').val(), a.modal("hide")) : void 0 != i.attr("data-lead-id") && (t += "?opened_from_lead_id=" + i.attr("data-lead-id")), requestGet("tasks/get_task_data/" + e + t).done(function (e) {
        _task_append_html(e)
    }).fail(function (e) {
...
function save_ei_items_order() {
    var e,
        t = $(".table.invoice-items-preview.items tbody tr,.table.estimate-items-preview.items tbody tr,.table.credit-note-items-preview.items tbody tr"),
        a = 1,
        i = [];
...
function calculate_total() {
    ...
    $(".tax-area").remove(), $.each(p, function () {
        "" === (r = $(this).find("[data-quantity]").val()) && (r = 1, $(this).find("[data-quantity]").val(1)), n = accounting.toFixed($(this).find("td.rate input").val() * r, app_decimal_places), n = parseFloat(n), $(this).find("td.amount").html(accounting.formatNumber(n)), l += n, i = $(this), (a = $(this).find("select.tax").selectpicker("val")) && $.each(a, function (a, l) {
        ...
        "" !== u && 0 != u && "before_tax" == v && h.hasClass("discount-type-percent") ? (total_tax_calculated = t * u / 100, t -= total_tax_calculated) : "" !== f && 0 != f && "before_tax" == v && h.hasClass("discount-type-fixed") && (t -= t * (f / l * 100) / 100), d += t, t = accounting.formatNumber(t), $("#tax_id_" + slugify(e)).html(t)
    ...
    var b = "-" + accounting.formatNumber(c);
...
var original_top_search_val, table_leads, table_activity_log, table_estimates, table_invoices, table_tasks,table_tasks_due_date
...
$("body").on("loaded.bs.select change", "select.ajax-search", function (e) {
    ...
    if (i && $("#search_input").val(i).trigger("keyup"), $("body").on("blur", "#timesheet_duration", function () {
        ...
        tinyMCE.remove(".tinymce-task"), "undefined" != typeof _ticket_message && (_ticket_message = void 0), void 0 == $(this).attr("data-lead-id") || $(this).attr("data-task-created") || init_lead($(this).attr("data-lead-id")), $("body #_task_modal .datepicker").datetimepicker("destroy"), $("#_task").empty()
    ...
    if ($("body").on("change", 'input[name="contacted_today"]', function () {
        ...
        null !== e && void 0 !== e ? $(e).valid() && $(this).button("loading") : $(this).button("loading")
        ...
        e.preventDefault();
        var t, a, i = $(this);
        t = i.hasClass("notification_link") ? i.data("link") : e.currentTarget.href;
        var n = !0;
        (t = t.split("#"))[1] && t[1].indexOf("=") > -1 && (n = !1, a = t[1].split("=")[1], t[1].indexOf("postid") > -1 ? (postid = a, $(".open_newsfeed").click()) : t[1].indexOf("taskid") > -1 ? init_task_modal(a) : t[1].indexOf("leadid") > -1 ? init_lead(a) : t[1].indexOf("eventid") > -1 && view_event(a)), i.hasClass("desktopClick") || i.parent("li").find(".not-mark-as-read-inline").click(), n && setTimeout(function () {
    ...
    g.length > 0 && (g = g.sortable({
        ...
        success: function (e, t) {
            ...
            a = "download/file/sales_attachment/", i = "delete_" + n + "_attachment", "invoice" == n ? init_invoice(t.rel_id) : "credit_note" == n ? init_credit_note(t.rel_id) : "estimate" == n ? $("body").hasClass("estimates-pipeline") ? estimate_pipeline_open(t.rel_id) : init_estimate(t.rel_id) : "proposal" == n && ($("body").hasClass("proposals-pipeline") ? proposal_pipeline_open(t.rel_id) : init_proposal(t.rel_id));
            var s = "";
        ...
        requestGetJSON("invoices/client_change_data/" + e + "/" + (n = void 0 === n ? "" : n)).done(function (e) {
            ...
            for (var n in billingAndShippingFields) billingAndShippingFields[n].indexOf("shipping") > -1 && (billingAndShippingFields[n].indexOf("country") > -1 ? $('select[name="' + billingAndShippingFields[n] + '"]').selectpicker("val", e.billing_shipping[0][billingAndShippingFields[n]]) : billingAndShippingFields[n].indexOf("shipping_street") > -1 ? $('textarea[name="' + billingAndShippingFields[n] + '"]').val(e.billing_shipping[0][billingAndShippingFields[n]]) : $('input[name="' + billingAndShippingFields[n] + '"]').val(e.billing_shipping[0][billingAndShippingFields[n]]));
            init_billing_and_shipping_details();
...
function showSummary() {
    document.getElementById("ctlsummarytab").className = document.getElementById("ctlsummarytab").className.replace(/\bsummarytab\b/g, "");
}