...
<script>
    $(function(){
        ...
        var tAPI = initDataTable('.table-clients', admin_url+'customers/table', [0], [0], CustomersServerParams,<?php echo do_action('customers_table_default_order',json_encode(array(2,'asc'))); ?>);
