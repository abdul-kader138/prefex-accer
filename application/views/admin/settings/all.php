   ...
   <div class="content">
      ...
      <div class="row">
         ...
         <div class="col-md-3">
            ...
            <div style="display:inone" class="panel_s">
               <div class="panel-body">
                  Accerp &copy; <?php echo date("Y");?>
		  <a style="display:none" href="<?php echo admin_url('settings?group=update'); ?>" class="<?php if($this->input->get('group') == 'update'){echo 'bold';} ?>"><?php echo _l('settings_update'); ?></a>
