<div class="row">
	<div class="col-md-12">
		...
		<div class="form-group" app-field-wrapper="settings[recaptcha_site_key]">
	        <label for="settings[recaptcha_site_key]" class="control-label">Recaptcha Site Key</label>
	        <input type="text" id="settings[recaptcha_site_key]" name="settings[recaptcha_site_key]" class="form-control" value="<?= get_option('recaptcha_site_key') ?>">
	      </div>
	      <div class="form-group" app-field-wrapper="settings[recaptcha_secret_key]">
	        <label for="settings[recaptcha_secret_key]" class="control-label">Recaptcha Secret Key</label>
	        <input type="text" id="settings[recaptcha_secret_key]" name="settings[recaptcha_secret_key]" class="form-control" value="<?= get_option('recaptcha_secret_key'); ?>">
	      </div>
	</div>
</div>
