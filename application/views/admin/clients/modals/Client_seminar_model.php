...
class Client_seminar_model extends CRM_Model
{
    ...
    */
    public function get_customer_groups($id)
    {
        ...
        return $this->db->get('tblcostomerseminar')->result_array();
    }
        ...
        if (sizeof($customer_groups) > 0) {
            ...
            if (isset($groups_in)) {
                foreach ($groups_in as $group) {
                    ...
                    $_exists = $this->db->get('tblcostomerseminar')->row();
                    if (!$_exists) {
                        if (empty($group)) {
                            continue;
                        }
                        $this->db->insert('tblcostomerseminar', [
                            'customer_id' => $id,
                            'groupid'     => $group,
                        ]);
                        if ($this->db->affected_rows() > 0) {
